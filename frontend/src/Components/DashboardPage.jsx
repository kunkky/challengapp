...
const DashboardPage = () => {
  return (
    <div>     
      <div className="w-full grid sm:grid-cols-2 sm:p-0 sm:px-10 px-5 gap-5 sm:gap-10 grid-cols-1 flex-row justify-between items-center">
        <div className="sm:p-5 bg-blue-100 shadow-sm rounded-md flex gap-2 items-center p-2 ">
          <div className=" bg-slate-50 flex justify-center items-center rounded-full w-auto h-auto p-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bar-chart-steps text-blue-400" viewBox="0 0 16 16">
      ...
      <div className=" w-full grid sm:grid-cols-2 sm:p-0 sm:px-10 px-5 gap-5 sm:gap-10 grid-cols-1">
        ...
        {/* <div className="bg-slate-50 p-10 rounded-lg flex justify-between items-center col-span-2 flex-row">
          <div className="">
        ...
        <div className="bg-slate-50 p-10 rounded-lg flex justify-between items-center col-span-1 flex-row">
          ...
          <div className="">
            ...
            <NavLink to="/challenge/html" className='bg-[#121212] p-3 rounded text-white border-0'>Take Challenge</NavLink>
          </div>
        </div>
*/}
        <div className="bg-slate-50 p-10 rounded-lg flex justify-between items-center col-span-1 flex-row">
